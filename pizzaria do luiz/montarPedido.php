                ...
                <div class="saborEborda"> 
                            ...
                            <label for="sabor">
                                ...
                                <div id="saboresContainer">
                                    ...
                                    // Sabores salgados
                                    $sqlSalgados = "SELECT * FROM montar WHERE id_login = $id_login AND id_variedades = 4";
                                ...
                                <?
                                  ...
                                  if ($resultBordas->num_rows > 0) {
                                      ...
                                      while ($rowBorda = $resultBordas->fetch_assoc()) {
                                          echo '<input type="checkbox" class="bordaCheckbox" value="' . $rowBorda["nome"] . '"> ' . $rowBorda["nome"] . '<br>';
                                      }
                                  }
